...
#define		FILENAME_ALIST12	"../data/dvbs2_r12.alist"
#define		FILENAME_ALIST34	"../data/dvbs2_r34.alist"
...
int main(int argc, char **argv)
{
	...
	if( 1 )
	{
		LDPC_Parity	lp( FILENAME_ALIST34, "alist" );
		LDPC_Code	ldpc( &lp );
		ldpc.save_code(FILENAME_IT34);
	}
